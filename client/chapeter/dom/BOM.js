...
// let items1 = document.querySelectorAll('#video1');
...
// let items2 = document.querySelectorAll('#video2');
...
let foods = ['김볶', '참치', '삽겸', '곱창', '냉면']


const foodselect = () => {
  for (let i = 0; i < foods.length; i++) {
    let rdn = Math.floor(Math.random() * foods.length);

    return console.log(foods[rdn]);
  }
}
foodselect();